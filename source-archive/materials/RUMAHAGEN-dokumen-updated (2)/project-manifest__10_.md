...
**Disusun berdasarkan:** seluruh dokumen governance terbaru yang tersedia — `architecture-decision-records.md` (Baseline, **v1.1**, 28 ADR + `ADR-046` — dikonsolidasi 5 Agustus 2026 dari 9 file snapshot, termasuk perbaikan tuntas regresi `ADR-005`/`ADR-006` di entri sumber), `technology-decisions.md` (Baseline, v1.6), `SYSTEM-ARCHITECTURE.md` (Baseline, v1.6), `dependency-manifest.md` (Baseline, v1.6), `PROJECT-CONSTITUTION.md` (Baseline, v1.8 — memenuhi peran *Engineering Guidelines*), `development-playbook.md`/`AI-DEVELOPMENT-BLUEPRINT.md` (Baseline, v1.6), `CURRENT-PROJECT-STATE.md`, `decision-log.md` (46 entry), `CHANGELOG.md` (rilis `0.2.2`), dan `document-governance-baseline-register.md` (Baseline, v1.1 — isi diperbarui 5 Agustus 2026). Dokumen pendukung yang tidak direvisi pada siklus ini (PRD, API Spec, User Flow, SEO Spec, `AI-CONTEXT-PACK.md`, `DEVELOPMENT-ROADMAP.md`, `TASK-TEMPLATE.md`, `foundation-validation-report.md`, `executive-architecture-review.md`, `synchronization-report-adr-001.md`) tetap dirujuk pada versi terakhir yang tercatat sebelumnya — **`ERD-Skema-Database.md` (v1.2) direvisi sebagian** pada siklus 4 Agustus (khusus soft-delete & klarifikasi Guest, bukan Modul 12/13). **Catatan cakupan siklus 5 Agustus:** murni konsolidasi/perbaikan integritas dokumentasi `architecture-decision-records.md` — tidak ada dokumen turunan lain yang direvisi kontennya (lihat Bagian 14A).
...
| **Version** | Rilis proyek **`0.2.2`** (`CHANGELOG.md`) · `PROJECT-CONSTITUTION.md` **v1.8** · `architecture-decision-records.md` **v1.1** · `technology-decisions.md`/`SYSTEM-ARCHITECTURE.md`/`dependency-manifest.md`/`development-playbook.md` **v1.6** · `ERD-Skema-Database.md` **v1.2** · dokumen sumber bisnis/data/API v1.1 lain (belum disinkronkan siklus ini) · Manifest ini sendiri **v1.7** |
...
| **Last Updated** | 4 Agustus 2026 — resolusi **OD-02** (seed role final = 7), **OD-06** (Owner seluruh dokumen → Mujtahid Aktanto), **OD-07** (soft-delete diperluas ke 8 tabel, `ADR-046`) — **6 dari 6 kondisi GO WITH CONDITIONS CTO kini terpenuhi**; 5 dokumen naik status ke Baseline |
