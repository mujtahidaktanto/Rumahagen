...
> **Catatan audit (ditambahkan oleh siklus konsolidasi 10 Agustus 2026):** Dokumen ini sebelumnya tidak memiliki tabel Riwayat Versi — hanya field `Versi`/`Tanggal` tunggal di header. Tabel di bawah disusun murni dari isi setiap snapshot yang diaudit. 4 baris terakhir sama-sama berlabel Versi 2.0 dan tanggal 6 Agustus 2026 — ini **bukan duplikasi keliru**, melainkan snapshot penambahan status "Closed" berurutan pada tanggal yang sama (verifikasi diff: 0 baris hilang antar keempatnya), konsisten pola "versi tidak naik untuk update status" yang berlaku di dokumen governance proyek ini.

| Versi | Tanggal | Ringkasan Perubahan Utama |
|---|---|---|
| 1.0 | 6 Agu 2026 | Dokumen baru — 7 Module Planning diperiksa, 18 isu. |
| 1.1 | 6 Agu 2026 | +3 temuan MP-03 (termasuk T1-02, dampak SEO tertinggi sejauh ini) → 22 isu. |
| 1.2 | 6 Agu 2026 | +2 temuan MP-05, termasuk T1-03 (celah bypass moderasi event). |
| 1.3 | 6 Agu 2026 | +2 temuan editorial MP-07 — modul pertama tanpa temuan Tier 1-3 baru. |
| 1.4 | 6 Agu 2026 | MP-11 memperkuat T1-02 dengan sumber independen ke-4, +1 isu Tier 4. |
| 1.5 | 6 Agu 2026 | +1 temuan editorial MP-08 — modul kedua tanpa temuan Tier 1-3 baru. |
| **2.0 (FINAL)** | 6 Agu 2026 | Seluruh 13 Module Planning selesai disusun — 32 isu total, seluruh status masih terbuka. |
| 2.0 *(snapshot, versi tidak naik)* | 6 Agu 2026 | +Status Batch 1 (4 Tier 1 + T3-06 Closed) & Batch 2 (2 Tier 2 + 5 Tier 3 Closed via OD-16 s.d. OD-22). |
| 2.0 *(snapshot, versi tidak naik)* | 6 Agu 2026 | +OD-23 (T3-02) Closed — seluruh Tier 1, 2, 3 (7 baris bernomor) kini Closed. |
| 2.0 *(snapshot, versi tidak naik)* | 6 Agu 2026 | +Batch 3 (audit menyeluruh Authorization Spec, 22 baris `PERM-XXX` dikoreksi → v1.1) + T4-06 (SSO Apple, Opsi B) — **seluruh 32 isu Closed. — VERSI TERKINI** |
