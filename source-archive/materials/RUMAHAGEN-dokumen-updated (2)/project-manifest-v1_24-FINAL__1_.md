...
| **Version** | Rilis proyek **`0.7.16`** (`CHANGELOG.md`) · `PROJECT-CONSTITUTION.md` **v1.9** · `architecture-decision-records.md` **v1.1** · `technology-decisions.md`/`SYSTEM-ARCHITECTURE.md`/`dependency-manifest.md`/`development-playbook.md` **v1.6** · `PRD.md` **v1.3-FINAL** · `Entity-Mapping.md` **v1.0 (Baseline)** · `ERD-Skema-Database.md` **v1.4-FINAL (Baseline)** · `User-Flow.md` **v1.2 (Baseline)** · `API-Specification.md` **v1.3-FINAL (Baseline, -FIXED tersedia)** · `Authorization-Access-Control-Specification.md` **v1.1-FINAL (Baseline)** · `Functional-Specification.md` **v1.0 (Baseline)** · `UI-Specification.md` **v1.0 (Baseline)** · `Technical-Specification.md` **v1.0 (Baseline)** · `document-governance-baseline-register.md` **v1.8** · 13 `MP-XX-*.md` Module Planning **dikonsolidasi penuh (9-10 Agustus 2026)** · Manifest ini sendiri **v1.24** |
...
| **Last Updated** | 10 Agustus 2026 — **konsolidasi riwayat versi 13 Module Planning + SYSTEM-ARCHITECTURE.md + AI Development Blueprint selesai penuh**; 7 regresi dokumentasi-vs-implementasi aktif ditemukan & diperbaiki (lihat Bagian 14B s.d. 14O). *(Riwayat: 5 Agustus 2026 — pengesahan status Baseline untuk 8 dokumen. 5 Agustus 2026 — 3 dokumen baru Functional/UI/Technical Specification dibuat.)* |
