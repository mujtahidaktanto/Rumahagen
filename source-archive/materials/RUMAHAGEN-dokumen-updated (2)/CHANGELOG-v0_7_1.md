...
**`0.7.1`** — *Initial Development*
Dirilis: 2026-08-06
Fase: Pra-Development — **T4-06 (SSO Apple) diselesaikan — Issue Register 32/32 isu Closed, tuntas.** Owner memilih Opsi B: referensi SSO Apple dipertahankan di PRD/Functional Spec/User Flow Modul 1, ditandai eksplisit "belum diimplementasikan / roadmap masa depan" (6 lokasi). **Ini adalah rilis PATCH** — koreksi editorial murni, tidak ada perubahan scope/skema/API. **Dengan rilis ini, seluruh Issue Register (`ISSUE-REGISTER-Konsolidasi-FINAL.md`) tuntas — tidak ada satu pun item governance tersisa yang menghalangi Sprint S0.**

*(Riwayat: `0.7.0`, dirilis 2026-08-06 — Issue Register Batch 3, audit Authorization Spec v1.1, MINOR. `0.6.0`, dirilis 2026-08-06 — OD-23, kebijakan review agen & self-review, MINOR. `0.5.0`, dirilis 2026-08-06 — Issue Register Batch 2, 7 Open Decision, MINOR.)*
...
## [Unreleased]
Belum ada perubahan yang menunggu rilis berikutnya. **Issue Register 100% Closed (32/32 isu)** — tidak ada lagi item governance yang menunggu. Perubahan berikutnya murni implementasi kode saat Sprint S0/modul dimulai: endpoint yang kontraknya sudah didesain (`/admin/internal-users`, `/admin/developer-projects` CRUD, upsert review agen, dst.), registrasi `BR-XXX`/`API-XXX`, sinkronisasi `ERD-Diagram-...v1.1.mermaid`, high-fidelity mockup.
