...
| **Version** | Rilis proyek **`0.4.1`** (`CHANGELOG.md`) · `PROJECT-CONSTITUTION.md` **v1.8** · `architecture-decision-records.md` **v1.1** · `technology-decisions.md`/`SYSTEM-ARCHITECTURE.md`/`dependency-manifest.md`/`development-playbook.md` **v1.6** · `PRD.md` **v1.2** · `Entity-Mapping.md` **v1.0 (Baseline)** · `ERD-Skema-Database.md` **v1.3 (Baseline)** · `User-Flow.md` **v1.2 (Baseline)** · `API-Specification.md` **v1.2 (Baseline)** · `Authorization-Access-Control-Specification.md` **v1.0 (Baseline)** · `Functional-Specification.md` **v1.0 (Baseline)** · `UI-Specification.md` **v1.0 (Baseline)** · `Technical-Specification.md` **v1.0 (Baseline)** · `document-governance-baseline-register.md` **v1.4** · Manifest ini sendiri **v1.10** |
...
| **Last Updated** | 5 Agustus 2026 — **pengesahan status Baseline** untuk 8 dokumen atas perintah eksplisit Owner (Entity Mapping, ERD v1.3, API Spec v1.2, User Flow v1.2, Authorization Spec, Functional Spec, UI Spec, Technical Spec). **Tidak ada lagi dokumen aktif berstatus Draft** di seluruh proyek. *(Riwayat: 5 Agustus 2026 — 3 dokumen baru Functional/UI/Technical Specification dibuat, menutup gap Planned/Not Ready sejak awal proyek.)* |
