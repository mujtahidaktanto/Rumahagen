...
### D4-PRD-01 — Canonical Title/Awarding product capabilities
Product must support:
- governed Title catalog;
- qualifying routes and prerequisites;
- progress/qualification status;
- accepted evidence;
- Award Result and detail/provenance;
- Award lifecycle;
- appeal;
- Primary/Featured presentation;
- Learning/Partner integration as evidence;
- governed administration.

### D4-PRD-02 — Product boundaries
- Certificate/Credential remains separate from Title/Award.
- Learning supplies evidence/outcomes; Awarding evaluates qualification.
- Payment confirmation does not directly grant a Title.
- Presentation choice is not Award ownership.
- Historical Awards remain explainable after Title/Path/Rule configuration changes.

### D4-PRD-03 — Qualification
AND/OR/grouped conditions are supported according to Awarding Rule. Learning completion, assessment, LP or partner outcome counts only when the applicable Path/Rule permits it.

### D4-PRD-04 — Lifecycle
Expired, Revoked, Appeal and Restored are distinct governed outcomes. Successful appeal restores the same Award Instance.

### D4-PRD-05 — Presentation
Primary max 1; Featured max 3. Removing Featured does not delete the Award. Revoked Awards cannot remain Featured.

### D4-PRD-06 — OD-06
Actor labels must use existing roles + capabilities + Authority/Scope Binding. No dedicated Issuer role is required by AEP3.
