...
| **v1.28** (rilis 0.7.20, tidak naik) | 11 Agu 2026 | Penetapan resmi nama brand/produk **RUMAHAGEN** oleh Owner, menggantikan placeholder `{nama_platform}` — dicatat sebagai `decision-log.md` OD-26 dan `document-governance-baseline-register.md` Governance Notes poin 39 (naik ke v1.11) (Governance Notes poin 16). **— VERSI TERKINI** |
...
| **Last Updated** | **10 Agustus 2026 — adopsi resmi `document-governance-baseline-register.md` v1.10 dan `CURRENT-PROJECT-STATE.md` rev. 9, mengonfirmasi keduanya sebagai versi resmi berlaku (menggantikan v1.9 dan rev. 8).** Seluruh catatan "draf, belum resmi" di Bagian 4/5/8/10/19 dihapus, digantikan status resmi. Lihat Governance Notes poin 15. *(Riwayat: 10 Agustus 2026 — rekonsiliasi Bagian 4, 6, 7, 8. Ditemukan bagian-bagian ini tertinggal sinkronisasi sejak ~4 Agustus meski nomor versi dokumen sudah naik ke v1.25 — Bagian 4 masih mencantumkan PRD v1.1/ERD v1.2/API Spec v1.1, 3 dokumen Baseline sejak 5 Agustus tidak tercatat sebagai baris; Bagian 6 belum mencantumkan `ADR-029`; Bagian 7 kehilangan 9 Open Decision (OD-16 s.d. OD-24); Bagian 8 mewarisi gap yang sama. Lihat Governance Notes poin 14. 10 Agustus 2026 — audit ulang MP-02 selesai, tidak ada regresi.)* |
...
## D6 Project Manifest Addendum
The manifest's AEP sequence and global synchronization state are updated to reflect completion of the locked AEP1→AEP2→AEP3→AEP4 sequence and D5 cross-domain reconciliation. Any older statement that global synchronization is still deferred is historical and is superseded by this D6 gate.
