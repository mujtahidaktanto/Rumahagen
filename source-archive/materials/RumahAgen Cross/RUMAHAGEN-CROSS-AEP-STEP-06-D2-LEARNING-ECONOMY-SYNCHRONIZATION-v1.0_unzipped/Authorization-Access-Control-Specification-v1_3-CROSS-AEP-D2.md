...
### D2-RBAC-01 — Authority separation
RBAC remains authorization authority. Learning Point state is economic/progression state.

Therefore:
- learner cannot directly create official LP transactions or mutate LP balance;
- Learning administration/issuance actions require governed authorization;
- Skill/Credential issuance is not authorized merely because a client reports completion;
- commercial payment success does not mutate Learning permissions.

### D2-RBAC-02 — Capability categories
Subject to final permission governance, downstream RBAC must distinguish:
- learning administration/configuration;
- learning content/activity administration;
- LP issuance/adjustment authorization;
- assessment administration;
- Skill/Credential issuance;
- partnership result management;
- audit/provenance/reconciliation access.

These are capability categories, not final permission IDs.

### D2-RBAC-03 — Physical hold
Exact permission IDs, role assignments, scope values and RLS remain downstream.
