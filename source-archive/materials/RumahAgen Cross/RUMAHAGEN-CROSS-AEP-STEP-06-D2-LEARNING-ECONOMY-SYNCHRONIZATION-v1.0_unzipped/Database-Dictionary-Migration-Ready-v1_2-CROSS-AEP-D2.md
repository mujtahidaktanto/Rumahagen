...
### D2-DICT-01
The Database Dictionary must follow the D2 logical model.

### D2-DICT-02 — Required coverage
The dictionary must eventually define physical representation for:
- LP transaction/ledger;
- provenance;
- earned/purchased classification;
- activity/completion reference;
- progression/unlock;
- assessment/competency;
- Skill;
- Credential;
- partner result/provenance;
- Learning configuration;
- payment/grant correlation;
- idempotency;
- audit.

### D2-DICT-03 — Historical integrity
Configuration changes never rewrite historical LP transactions, grants, purchases or provenance.

### D2-DICT-04 — Physical hold
No exact physical table/column/key/cardinality/state enum/evidence-storage choice is introduced here.
