...
### D2-PRD-01 — Canonical Learning Economy product requirements
The product baseline must preserve:
- “Learn for free. Grind to earn. Pay to accelerate. Prove to certify.”
- Learning Points as economic/progression mechanism;
- transaction/ledger and provenance;
- earned vs purchased LP distinction;
- learning-path progression/unlock;
- assessment/competency gate;
- Skill/Credential separation from completion;
- Internal Learning vs Partnership Learning boundary;
- configurable Learning Economy parameters;
- historical integrity;
- idempotent purchased-LP grant;
- Commercial-owned payment and trusted payment handoff.

### D2-PRD-02 — Product invariants
Purchased LP never equals “pay-to-pass”.
Completion never guarantees Skill/Credential.
Learning Points never become Commercial Entitlement.
Partner credential provenance is retained.
Configuration changes do not rewrite historical LP records.

### D2-PRD-03 — MADCR-049 hold
Any product behavior that depends on final Learning Activity evidence semantics remains conditional until MADCR-049 is independently resolved.
