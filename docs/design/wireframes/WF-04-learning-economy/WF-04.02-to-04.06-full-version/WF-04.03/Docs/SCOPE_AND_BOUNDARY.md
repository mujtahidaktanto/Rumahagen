# WF-04.03 — Full Rebuild / Correction v1.2

## Scope
My Learning + Learning Path progression + Path administration. Explicit activity-instance state and governed progression.
