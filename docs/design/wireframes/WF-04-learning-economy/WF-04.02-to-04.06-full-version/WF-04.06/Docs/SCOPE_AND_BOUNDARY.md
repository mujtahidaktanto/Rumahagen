# WF-04.06 — Full Rebuild / Correction v1.2

## Scope
Learning Economy/LP balance, complete transaction taxonomy, packages/acceleration handoff, redemption, configuration and LP adjustment.
