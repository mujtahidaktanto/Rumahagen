...
| **Fase H — Buyer** | — | ⬜ Belum dimulai: persona Buyer (lihat/daftar sesi pembelajaran, daftar event, pembelian/akses komersial, bukti sesi) | Dokumen sumber Buyer, shell nav Buyer |
| **Fase D-lanjutan — Admin** | — | ⬜ Belum dimulai: pengelolaan kursus/pelajaran/kuis (`courses`, `course-lessons`, `quizzes`, `quiz-questions`) dan pengalihan URL (`url_redirects`, 0051; terbukti tidak ada di layar Admin mana pun) | Layar Kelola Kursus, layar Pengalihan URL |
| **Fase C-lanjutan — Agent** | — | ⬜ Belum dimulai: layar Langganan Saya (`subscriptions`, 0071; layar M14 yang ada hanya katalog, add-on, dan riwayat pesanan) | Layar Langganan Saya |
