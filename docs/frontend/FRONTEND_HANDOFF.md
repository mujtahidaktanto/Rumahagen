...
- **Belum:** halaman Register/OTP/Recovery (Fase 2), badge status per entitas (dibuat per modul dari CHECK constraint), ikon khusus menu (sementara ikon netral), penyaringan menu Admin per kemampuan, Context Switcher Agent.
