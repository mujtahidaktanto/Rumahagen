# P4 Module Execution Specification Architecture — M15 v1.3
**Authority:** Qualification/Evidence/Award  
**Status:** FULL-VERSION / CURRENT SUCCESSOR EXECUTION ARCHITECTURE

## 1. Authority and Execution Boundary
- `M15` remains the semantic authority for its domain: **Qualification/Evidence/Award**.
...
- **PRESERVE** | M15 owns qualification/evidence evaluation/Award; consumes M04 evidence and must not absorb M14 Q01–Q64. | `M15-P4-WP03` | consequence: Carry unchanged into execution contract and regression acceptance.
- **PRESERVE** | Award provenance/rule-version snapshot and appeal/presentation remain explicit; presentation is downstream/non-owning. | `M15-P4-WP03` | consequence: Carry unchanged into execution contract and regression acceptance.
- **CONTROLLED** | Physical permission IDs/API/RLS/runtime remain downstream controlled; no invented authority identifiers. | `M15-P4-WP03` | consequence: Specify evidence/verification handoff; do not claim physical/runtime completion.
...
- **M15-P4-WP01 — Title**: dependency gate → contract definition → atomic tasks → validation → evidence → checkpoint → handoff.
- **M15-P4-WP02 — Path/Rule**: dependency gate → contract definition → atomic tasks → validation → evidence → checkpoint → handoff.
- **M15-P4-WP03 — Qualification/Evidence**: dependency gate → contract definition → atomic tasks → validation → evidence → checkpoint → handoff.
- **M15-P4-WP04 — Award/Presentation**: dependency gate → contract definition → atomic tasks → validation → evidence → checkpoint → handoff.
