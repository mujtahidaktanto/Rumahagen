...
**`0.7.2`** — *Initial Development*
Dirilis: 2026-08-07
Fase: Pra-Development — **OD-24: Gate implementasi kode Modul 12 (Organization) resmi terbuka.** Owner mengonfirmasi eksplisit gate M12 terbuka, melengkapi seluruh prasyarat teknis yang sudah terpenuhi sejak Batch 1 (RLS `org_invitations_insert`, T3-06). **Ini adalah rilis PATCH** — perubahan status governance murni, tidak ada perubahan scope/skema/API. **Dengan rilis ini, seluruh 13 modul proyek (termasuk M12 dan M13) berstatus GO tanpa syarat gate tambahan — tidak ada satu pun blocker governance tersisa di seluruh proyek.**

*(Riwayat: `0.7.1`, dirilis 2026-08-06 — T4-06 SSO Apple, penutup Issue Register 32/32 Closed, PATCH. `0.7.0`, dirilis 2026-08-06 — Issue Register Batch 3, audit Authorization Spec v1.1, MINOR. `0.6.0`, dirilis 2026-08-06 — OD-23, kebijakan review agen & self-review, MINOR. `0.5.0`, dirilis 2026-08-06 — Issue Register Batch 2, 7 Open Decision, MINOR.)*
...
## [Unreleased]
Belum ada perubahan yang menunggu rilis berikutnya. **Issue Register 100% Closed (32/32 isu)** dan **gate governance M12/M13 keduanya terbuka** — tidak ada lagi item governance yang menunggu di seluruh proyek. Perubahan berikutnya murni implementasi kode saat Sprint S0/modul dimulai: endpoint yang kontraknya sudah didesain (`/admin/internal-users`, `/admin/developer-projects` CRUD, upsert review agen, dst.), registrasi `BR-XXX`/`API-XXX`, sinkronisasi `ERD-Diagram-...v1.1.mermaid`, high-fidelity mockup.
