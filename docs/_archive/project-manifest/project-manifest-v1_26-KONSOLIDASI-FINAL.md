...
| **v1.26** (rilis 0.7.20, tidak naik) | 10 Agu 2026 | Rekonsiliasi Bagian 4/6/7/8 — ditemukan basi sejak ~4-5 Agustus meski nomor versi manifest terus naik; +9 Open Decision (OD-16–OD-24), +ADR-029, +3 baris Baseline (Entity Mapping/Authorization Spec/Functional-UI-Technical Spec), versi PRD/ERD/API Spec dikoreksi ke v1.3/v1.4/v1.3 (Governance Notes poin 14). **— VERSI TERKINI** |
...
| **Version** | Rilis proyek **`0.7.20`** (`CHANGELOG.md`) · `PROJECT-CONSTITUTION.md` **v1.9** · `architecture-decision-records.md` **v1.1 (29 ADR + ADR-046)** · `technology-decisions.md`/`SYSTEM-ARCHITECTURE.md`/`dependency-manifest.md`/`development-playbook.md` **v1.6** · `PRD.md` **v1.3-FINAL** · `Entity-Mapping.md` **v1.0 (Baseline)** · `ERD-Skema-Database.md` **v1.4-FINAL (Baseline)** · `User-Flow.md` **v1.2 (Baseline)** · `API-Specification.md` **v1.3-FINAL-FIXED (Baseline)** · `Authorization-Access-Control-Specification.md` **v1.1-FINAL (Baseline)** · `Functional-Specification.md` **v1.0 (Baseline)** · `UI-Specification.md` **v1.0 (Baseline)** · `Technical-Specification.md` **v1.0 (Baseline)** · `document-governance-baseline-register.md` **v1.9** · 13 `MP-XX-*.md` Module Planning **dikonsolidasi penuh, seluruhnya sudah diaudit ulang standar ketat (9-10 Agustus 2026)** · Manifest ini sendiri **v1.26** |
...
| **Last Updated** | **10 Agustus 2026 — rekonsiliasi Bagian 4, 6, 7, 8.** Ditemukan bagian-bagian ini tertinggal sinkronisasi sejak ~4 Agustus meski nomor versi dokumen sudah naik ke v1.25 — Bagian 4 (Current Baseline) masih mencantumkan PRD v1.1/ERD v1.2/API Spec v1.1 (seharusnya v1.3/v1.4/v1.3), 3 dokumen Baseline sejak 5 Agustus (Entity Mapping, Authorization Spec, Functional/UI/Technical Spec) tidak tercatat sebagai baris; Bagian 6 belum mencantumkan `ADR-029`; Bagian 7 kehilangan 9 Open Decision (OD-16 s.d. OD-24); Bagian 8 mewarisi seluruh gap yang sama. Seluruhnya disinkronkan pada revisi ini. Lihat Governance Notes poin 14. *(Riwayat: 10 Agustus 2026 — audit ulang MP-02 selesai, tidak ada regresi. 10 Agustus 2026 — konsolidasi riwayat versi 13 Module Planning + SYSTEM-ARCHITECTURE.md + AI Development Blueprint selesai penuh, 7 regresi ditemukan & diperbaiki, lihat Bagian 14B s.d. 14O.)* |
...
| document-governance-baseline-register.md | **1.9** *(draf konsolidasi v1.10 tersedia dari audit terpisah, belum resmi menggantikan v1.9 di repositori — lihat Governance Notes poin 14)* | ✅ 1.9 | ✅ **Baseline (BERLAKU)** — Governance Notes poin 1-37 | Mujtahid Aktanto (Solo Project Owner, AI-Assisted) | 10 Agu 2026 |
...
| Tata Kelola Dokumen Itu Sendiri | `document-governance-baseline-register.md` (v1.9) | — |
...
| 23 | document-governance-baseline-register.md | **1.9** *(draf konsolidasi v1.10 tersedia, belum resmi — lihat Governance Notes poin 14)* | ✅ Baseline | Meta-dokumen lifecycle/versi/ownership | Tata Kelola Dokumen | ✅ | 10 Agu 2026 |
...
| 21 | `document-governance-baseline-register.md` (v1.9) | Rujukan status/versi/ownership jika ragu dokumen mana yang menang |
...
> Konsisten dengan mandat Manifest ini: pertentangan yang ditemukan **dicatat**, **tidak diperbaiki sepihak** di sini. Poin 1–13 dipertahankan penuh dari Manifest versi sebelumnya (histori tidak dihapus); poin 14 baru ditambahkan pada siklus ini.
...
| Status/versi/ownership dokumen mana pun | `document-governance-baseline-register.md` (v1.9) |
