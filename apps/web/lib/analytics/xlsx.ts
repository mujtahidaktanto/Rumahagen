...
// "brand" dan "brandSub" = pita identitas RumahAgen (biru merek + navy, teks putih) untuk baris judul lembar pertama; tanpa gambar (pembuat ini belum mendukung gambar).
export type StyleKey = "default" | "title" | "header" | "int" | "idr" | "pct" | "date" | "note" | "bold" | "warn" | "delta" | "dec1" | "wrap" | "label" | "brand" | "brandSub";
const STYLE_INDEX: Record<StyleKey, number> = { default: 0, title: 1, header: 2, int: 3, idr: 4, pct: 5, date: 6, note: 7, bold: 8, warn: 9, delta: 10, dec1: 11, wrap: 12, label: 13, brand: 14, brandSub: 15 };
...
<xf numFmtId="0" fontId="6" fillId="4" borderId="0" xfId="0" applyFont="1" applyFill="1" applyAlignment="1"><alignment vertical="center"/></xf>
<xf numFmtId="0" fontId="7" fillId="5" borderId="0" xfId="0" applyFont="1" applyFill="1" applyAlignment="1"><alignment vertical="center"/></xf>
</cellXfs>
</styleSheet>`;
