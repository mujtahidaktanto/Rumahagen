// app/(publik)/developer/loading.tsx — keadaan memuat Daftar Proyek (kerangka kartu).
export default function DeveloperListLoading() {
  return (
    <div role="status" aria-label="Memuat daftar proyek" className="bg-surface">
