// app/(publik)/organisasi/loading.tsx — keadaan memuat Daftar Organisasi (kerangka kartu).
export default function OrganizationListLoading() {
  return (
    <div role="status" aria-label="Memuat daftar organisasi" className="bg-surface">
